...
if __name__ == '__main__':
    ...
    if args.restore_experiment is not None:
        prev_args, model, token_vocab, metadata_vocab, optimizer_state = restore_model(args.restore_experiment)
    ...
    batch_incr = batcher.sample_next if args.sample_metadata else batcher.marginal_next
