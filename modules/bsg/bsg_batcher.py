...
class BSGBatchLoader:
    ...
    def next(self, ids, full_metadata_ids, vocab, window_size):
        """
        :param ids: Flattened list of all token and metadata ids
        :param full_metadata_ids: For each element in ids provides its corresponding metadata id
        ...
        for batch_idx, center_idx in enumerate(batch_idxs):
            meta_ids[batch_idx] = full_metadata_ids[center_idx]
