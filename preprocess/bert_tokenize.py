...
if __name__ == '__main__':
    ...
    """
    with open('data/mimic/vocab.pk', 'rb') as fd:
    ...
    with open('data/mimic/clinic_bert_vocab.txt', 'r') as fd:
        clinic_bert_tokens = fd.readlines()

    clinic_bert_tokens = list(set(list(map(_standardize, clinic_bert_tokens))))
    vocab_fn = 'data/mimic/clinic_bert_plus_metadata_vocab.txt'
    ...
    out_fn = 'data/mimic/bert_tokenizer_vocab.pth'
